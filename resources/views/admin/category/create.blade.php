    ...
    <div class="row">
        <div class="col">
            <div class="card py-3 border-0">
                ...
                <form class="form-horizontal" id="create_cat_form" action="{{ url('/admin/categories') }}" method="post"
                    ...
                    <div>
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ old('name') }}" name="name" id="name"
                                class="form-control" placeholder="{{ __('Category Name') }}" autofocus>
                            <div class="invalid-div "><span class="name"></span></div>
                        </div>

                        <div class="form-group">
                            <label class="form-control-label" for="color">{{ __('Color') }}</label>
                            <input type="color" value="{{ old('color') }}" name="color" id="color"
                                class="form-control" placeholder="{{ __('Category color') }}" autofocus>
                            <div class="invalid-div "><span class="color"></span></div>
                        </div>
                        ...
                        <div class="text-center">
                            <button type="button" id="create_btn" onclick="all_create('create_cat_form','categories')"
