...
@section('content')
    ...
    <div class="header pt-9"
        style="background-image: url({{ asset('storage/images/app/' . $bg_img) }}); background-size: cover; background-position: center center;padding-bottom: 50px;">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <span
                                            class="h2 font-weight-bold mb-0">{{ ceil($payment) }}{{ $setting->currency_symbol }}</span>
                                    </div>
                                    <div class="col-auto">
                        ...
                        @else
                            <tr>
                                <th colspan="10" class="text-center">
                                    {{ __('Service not booked by any client') }}</th>
                            </tr>
                        @endif
                    </tbody>
                </table>
                        ...
                        @if (count($upcommings) != 0)
                            @foreach ($upcommings as $upcomming)
                                <tr>
                                    ...
                                    <td>{{ $upcomming->payment }}{{ $symbol }}</td>
                                    <td class="text-center">
                                        ...
                                        @elseif($upcomming->payment_status == 0)
                                            <span
                                                class="badge badge-pill badge-warning">{{ __('Unpaid') }}</span>
                                        @endif
                                    </td>
                                </tr>
                            @endforeach
