            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-header border-0">
                        ...
                        <button class="btn btn-primary addbtn float-right p-2"><a class="color-white"
                                href="{{ url('admin/employee/create') }}"><i
                                    class="fas fa-plus mr-1"></i>{{ __('Add New') }}</a></button>
                    </div>
                    <!-- table -->
                                ...
                                @if (count($emps) != 0)
                                    @foreach ($emps as $key => $emp)
                                        <tr>
                                            ...
                                            <td>
                                                <img src="{{ asset('storage/images/employee/' . $emp->image) }}"
                                            ...
                                            <td>
                                                <div class="avatar-group">
                                                    ...
                                                    @foreach ($emp->services as $service)
                                                        ...
                                                        @else
                                                            @php $remainingCount = count($emp->services) - 10; @endphp
                                        ...
                                        <td>
                                            <label class="custom-toggle">
                                                <input type="checkbox" onchange="hideEmp({{ $emp->emp_id }})"
                                        ...
                                        <td class="table-actions">
                                            @php
                                                $base_url = url('/');
                                            @endphp
                                            <a href="{{ url('admin/employee/' . $emp->emp_id) }}"
                                                class="table-action text-warning" data-toggle="tooltip"
                                                data-original-title="{{ __('View employee') }}">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="{{ url('admin/employee/edit/' . $emp->emp_id) }}"
                                            ...
                                            <button
                                                ...
                                                onclick="deleteData('admin/employee',{{ $emp->emp_id }},'{{ $base_url }}')"
                                                data-toggle="tooltip"
