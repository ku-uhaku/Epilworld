...
<body class="hold-transition skin-blue sidebar-mini">
   <div class="wrapper">
      ...
      if (isset($sales_id)) {
         ...
         $nbl = $q2->row()->nbl;
         $imputation = $q2->row()->imputation;
         $pompe = $q2->row()->pompe;
         $ville = $q2->row()->ville;
         $matricule = $q2->row()->matricule;

         $chauffeur = $q2->row()->chauffeur;
               ...
               <div class="col-md-12">
                  ...
                  <div class="box box-primary ">
                     ...
                     <div class="box-body">
                        ...
                        <div class="form-group">
                           <label for="nbl" class="col-sm-2 control-label">N°BL </label>
                           <div class="col-sm-3">
                              <input type="text" value="<?php echo  $nbl; ?>" class="form-control " id="nbl" name="nbl" placeholder="">
                              <span id="nbl_msg" style="display:none" class="text-danger"></span>
                           </div>
                           <label for="imputation" class="col-sm-2 control-label">Imputation </label>
                           <div class="col-sm-3">
                              <input type="text" value="<?php echo  $imputation; ?>" class="form-control " id="imputation" name="imputation" placeholder="">
                              <span id="imputation_msg" style="display:none" class="text-danger"></span>
                           </div>
                        </div>

                        <div class="form-group">
                           <label for="pompe" class="col-sm-2 control-label">Pompe </label>
                           <div class="col-sm-3">
                              <input type="text" value="<?php echo  $pompe; ?>" class="form-control " id="pompe" name="pompe" placeholder="">
                              <span id="pompe_msg" style="display:none" class="text-danger"></span>
                           </div>


                           <label for="ville" class="col-sm-2 control-label">Ville </label>
                           <div class="col-sm-3">
                              <input type="text" value="<?php echo  $ville; ?>" class="form-control " id="ville" name="ville" placeholder="">
                              <span id="ville_msg" style="display:none" class="text-danger"></span>
                           </div>
                        </div>

                        <div class="form-group">
                           <label for="chauffeur" class="col-sm-2 control-label">Chauffeur<label class="text-danger">*</label></label>
                           <div class="col-sm-3">

                              <select class="form-control select2" id='chauffeur' name="chauffeur">
                                 <?php
                                 $q1 = $this->db->query("select * from db_chauffeur where store_id=" . get_current_store_id());
                                 if ($q1->num_rows() > 0) {
                                    echo "<option value=''>-choisir-</option>";
                                    foreach ($q1->result() as $res1) {
                                       $selected = ''; // Initialize the selected attribute
                                       // Check if the current option is the one selected from the database
                                       if ($res1->chauffeur_name == $chauffeur) {
                                          $selected = 'selected';
                                       } else {
                                          $selected = '';
                                       }
                                       echo "<option value='" . $res1->chauffeur_name . "' $selected>" . $res1->chauffeur_name . "</option>";
                                    }
                                 } else {
                              ...
                              <span id="chauffeur_msg" style="display:none" class="text-danger"></span>

                           </div>
                           <label for="matricule" class="col-sm-2 control-label">Matricule </label>
                           <div class="col-sm-3">

                              <input type="text" disabled value="<?php echo  $matricule; ?>" class="form-control " id="matricule">
                              <input type="hidden" value="<?php echo  $matricule; ?>" class="form-control " name="matricule" placeholder="" id="matricule_t">
                              <span id="matricule_msg" style="display:none" class="text-danger"></span>
                           </div>
                        </div>
                        <div class="form-group">
                                    ...
                                    <div class="box-header">
                                       <div class="col-md-8 col-md-offset-2 d-flex justify-content">
                                          <div class="input-group">
                                             ...
                                             <input type="text" class="form-control " placeholder="<?= $this->lang->line('Item name/Barcode/Itemcode') ?>" autofocus id="item_search">
                              ...
                              <div class="col-md-12">
                                 <div class="form-group">
                                    ...
                                    <table class="col-md-9">
                                       <tr>
                                          <th class="text-right" style="font-size: 17px;">Montant TTC</th>
                                       ...
                                       <tr>
                                          <th class="text-right" style="font-size: 17px;">Montant HT</th>
                                          <th class="text-right" style="padding-left:10%;font-size: 17px;">
                                             <h4><b id="subtotal_ht" name="subtotal_ht">0.00</b></h4>
                                          </th>
                                       </tr>


                                       <tr>
                                          <th class="text-right" style="font-size: 17px;">Montant TVA</th>
                                          <th class="text-right" style="padding-left:10%;font-size: 17px;">
                                             <h4><b id="subtotal_tva" name="subtotal_tva">0.00</b></h4>
                                          </th>
                                       </tr>
                     ...
                     <div class="box-footer col-sm-12">
                        <center>
                           ...
                           <div class="col-md-3 col-md-offset-3">
                              <button type="button" id="<?php echo $btn_id; ?>" class="btn btn-block btn-success payments_modal" title="Save Data"><?= $this->lang->line('save') ?></button>
                           </div>
                           <div class="col-sm-3"><a href="<?= base_url() ?>dashboard">
                                 <button type="button" class="btn btn-block btn-warning" title="Go Dashboard"><?= $this->lang->line('close') ?></button>
                              </a>
                           </div>
                        </center>
                     </div>
   ...
   <script>
      ...
      function final_total() {
         ...
         for (i = 1; i <= rowcount; i++) {
            ...
            if (document.getElementById("td_data_" + i + "_3")) {
               ...
               if ($("#td_data_" + i + "_3").val() != null && $("#td_data_" + i + "_3").val() != '') {
                  ...
                  montant_ht = montant_ht + + +parseFloat($("#td_data_" + i + "_9").val()) - (+$("#td_data_" + i + "_11").val());
                  subtotal = subtotal + + +parseFloat($("#td_data_" + i + "_9").val());
                  if ($("#td_data_" + i + "_7").val() >= 0) {
                     tax_amt = tax_amt + + +$("#td_data_" + i + "_7").val();
                  }
                  if ($("#td_data_" + i + "_11").val() >= 0)(
                     tax_amtt = tax_amtt + + +$("#td_data_" + i + "_11").val()
                  );
         ...
         if ((subtotal != null || subtotal != '') && (subtotal != 0)) {
            ...
            $("#subtotal_ht").html(to_Fixed(montant_ht));
            $("#subtotal_tva").html(to_Fixed(tax_amtt));
   ...
   <script>
      ...
      $(document).ready(function() {
         $('#chauffeur').on('change', function() {
            var chauffeurName = $(this).val();

            // Make an AJAX request to get the corresponding matricule
            $.post(
               base_url + "chauffeur/get_matricule", {
               ...
               function(result) {
                  ...
                  if (result) {
                     console.log(result);
                     $('#matricule').val(result);
                     $('#matricule_t').val(result);
                  } else if (result == "failed") {
                     toastr["error"](
                        `! Impossible d'ajouter ou de mettre à jour. Veuillez réessayer!`
                     );
                  } else {
                     $('#matricule').val(result);
                  }
