<div class="container-fluid sidebar_open @if ($errors->any()) show_sidebar_create @endif"
    id="add_parametrageService_sidebar">
    <div class="row">
        <div class="col">
            <div class="card py-3 border-0">
                ...
                <div class="border_bottom_pink pb-3 pt-2 mb-4">
                    ...
                    <button type="button" class="add_parametrageService close">&times;</button>
                </div>
                <form class="form-horizontal" id="create_user_form" method="post" enctype="multipart/form-data"
                    action="{{ url('/admin/parametrage/user_service/store') }}">
                    ...
                    <div class="my-0">
                        ...
                        <div>
                            ...
                            <select name="gender" id="genderr" class="select2 gender">
                        ...
                        <div ,>
                            ...
                            <select name="service" id="servicee" class="select2 ">
