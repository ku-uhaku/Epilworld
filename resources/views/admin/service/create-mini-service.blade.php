<div class="container-fluid sidebar_open @if ($errors->any()) show_sidebar_create @endif"
    id="add_mini-service_sidebar">
    <div class="row">
        <div class="col">
            <div class="card py-3 border-0">
                <!-- Card header -->
                <div class="border_bottom_pink pb-3 pt-2 mb-4">
                    <span class="h3">{{ __('Create mini Service') }}</span>
                    <button type="button" class="add_mini-service close">&times;</button>
                </div>
                <form class="form-horizontal" id="create_mini_service_form" method="post" enctype="multipart/form-data"
                    action="{{ url('/admin/serviceDetails/store') }}">
                    @csrf
                    <div class="my-0">
                        ...
                        <div class="text-center">
                            <button type="submit" id="create_btn"
                                onclick="all_create('create_mini_service_form','serviceDetails')"
