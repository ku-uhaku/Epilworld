    ...
    <div class="row">
        <div class="col">
            <div class="card py-3 border-0">
                ...
                <form class="form-horizontal" id="create_service_form" method="post" enctype="multipart/form-data"
                    action="{{ url('/admin/service') }}">
                    @csrf
                    <div class="my-0">
                        ...
                        <div class="text-center">
                            <button type="button" id="create_btn"
                                onclick="all_create('create_service_form','services')"
