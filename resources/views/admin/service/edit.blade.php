                        ...
                        <div class="my-0">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="name" class="form-control"
                                    placeholder="{{ __('Service Name') }}" autofocus>
                            ...
                            <div class="form-group">
                                <label class="form-control-label"
                                    for="time">{{ __('Service Time (Minutes)') }}</label>
                                <input type="text" name="time" id="time" class="form-control"
                                    placeholder="{{ __('Service Time') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="NBS" id="NBS" class="form-control"
                                    placeholder="Nombre de séance" autofocus>
                                <div class="invalid-div "><span class="NBS"></span></div>
                            </div>

                            <div class="form-group">
                                <label class="form-control-label" for="frequency_nb">Frequency</label>
                                <div class="d-flex gap-2">
                                    <input type="text" value="{{ old('frequency_nb') }}" name="frequency_nb"
                                        id="frequency_nb" class="form-control mr-1" placeholder="Frequency"
                                        autofocus>
                            ...
                            <div class="text-center">
                                <button type="button" onclick="all_edit('edit_service_form','services')"
