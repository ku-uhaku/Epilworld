<nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
        ...
        <a class="navbar-brand pt-0" href="{{ url('admin/dashboard') }}">
            <img src="{{ asset('storage/images/app/' . $black_logo) }}" class="navbar-brand-img sidebar-logo"
                alt="...">
        </a>
        ...
        <div class="collapse navbar-collapse" id="sidenav-collapse-main">
            ...
            <div class="navbar-collapse-header d-md-none">
                <div class="row">
                    <div class="col-6 collapse-brand">
                        <a class="navbar-brand pt-0" href="{{ url('admin/dashboard') }}">
                            <img src="{{ asset('storage/images/app/' . $black_logo) }}" class="navbar-brand-img"
                                alt="...">
                        </a>
                    </div>
                </div>
            ...
            <ul class="navbar-nav">
                ...
                @if (Auth::user()->role != '5')
                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('admin/payment*') ? 'active' : '' }}"
                            ...
                            <span class="nav-link-text">Recette</span>
                        </a>
                    </li>

                    <li class="nav-item ">
                        <a class="nav-link {{ request()->is('admin/summary*') ? 'active' : '' }}"
                            href="{{ url('admin/summary') }}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('admin/room*') ? 'active' : '' }}"
                            href="{{ url('admin/room') }}">
                            <i class="fas fa-store text-cyan"></i>
                            <span class="nav-link-text">{{ __('Room') }}</span>
                        </a>
                    </li>
                ...
                @if (Auth::user()->role == '4')
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('admin/offer*') ? 'active' : '' }}"
                            href="{{ url('admin/offer') }}">
                ...
                @if (Auth::user()->role != '5')
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('admin/report*') ? 'active_text' : '' }}"
                            href="#navbar-examples1" data-toggle="collapse"
                            aria-expanded=" {{ request()->is('admin/report*') ? 'true' : '' }}" role="button"
                            aria-controls="navbar-examples">
                            <i class="fa fa-file text-blue"></i>
                            <span class="nav-link-text">{{ __('Reports') }}</span>
                        </a>

                        <div class="collapse  {{ request()->is('admin/report*') ? 'show' : '' }}"
                            id="navbar-examples1">
                            <ul class="nav nav-sm flex-column">
                                <li class="nav-item">
                                    <a class="nav-link {{ request()->is('admin/report/user*') ? 'active_text' : '' }}"
                                        href="{{ url('admin/report/user') }}">{{ __('User Report') }}</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link {{ request()->is('admin/report/revenue*') ? 'active_text' : '' }}"
                                        href="{{ url('admin/report/revenue') }}">{{ __('Revenue Report') }}</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                ...
                <li class="nav-item ">
                    <a class="nav-link {{ request()->is('admin/globalInvoice*') ? 'active' : '' }}"
                        href="{{ url('admin/globalInvoice') }}">
                        <i class="fas fa-star text-yellow"></i>
                        <span class="nav-link-text">{{ __('Historique global facturé') }}</span>
                    </a>
                </li>
                ...
                <li class="nav-item d-none">
                    <a class="nav-link {{ request()->is('admin/notification*') ? 'active' : '' }}"
                        ...
                        aria-expanded=" {{ request()->is('admin/notification*') ? 'true' : '' }}" role="button"
                        aria-controls="navbar-examples">
                        <i class="fa fa-bell text-red"></i>
                        <span class="nav-link-text">{{ __('Notification') }}</span>
                    </a>

                    <div class="collapse  {{ request()->is('admin/notification*') ? 'show' : '' }}"
                        id="navbar-examples">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a class="nav-link {{ request()->is('admin/notification/template') ? 'active_text' : '' }}"
                                    href="{{ url('admin/notification/template') }}">{{ __('Template') }}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ request()->is('admin/notification/send') ? 'active_text' : '' }}"
                                    href="{{ url('admin/notification/send') }}">{{ __('Send Notification') }}</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="nav-item d-none">
                    <a class="nav-link {{ request()->is('admin/parametrage*') ? 'active' : '' }}"
                        href="{{ url('admin/parametrage') }}">
                        <i class="fas fa-cog text-yellow"></i>
                        <span class="nav-link-text">{{ __('Parametrage') }}</span>
                    </a>
                </li>

                <li class="nav-item">
                    <a class="nav-link {{ request()->is('admin/report*') ? 'active_text' : '' }}"
                        href="#navbar-examples2" data-toggle="collapse"
                        aria-expanded=" {{ request()->is('admin/parametrage*') ? 'true' : '' }}" role="button"
                        aria-controls="navbar-examples">
                        <i class="fa fa-cog text-green"></i>
                        <span class="nav-link-text">{{ __('Paramétrage') }}</span>
                    </a>

                    <div class="collapse  {{ request()->is('admin/parametrage*') ? 'show' : '' }}"
                        id="navbar-examples2">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a class="nav-link {{ request()->is('admin/report/user*') ? 'active_text' : '' }}"
                                    href="{{ url('admin/parametrage/user_service') }}">{{ __('User Service') }}</a>
                            </li>
